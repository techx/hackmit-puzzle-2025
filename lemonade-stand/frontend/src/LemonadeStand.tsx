...
const DISTRIBUTABLE_LINK = "/lemonade_stand.tar.gz";
...
const LemonadeStand = ({ userId }: { userId: string }) => {
  ...
  const [, setStandErrors] = useState<Record<number, StandValidationErrors>>(
    {},
  );
      ...
      <div className={showModal ? "dimmed" : ""} style={{ flexGrow: 1 }}>
        <div className="relative mx-auto w-full max-w-2xl py-2">
          <img
            ...
            className="h-auto min-h-[15rem] w-full object-contain"
          />
          <div
          ...
          <h3 className="text-center text-2xl">
            <a
              className="relative cursor-pointer text-blue-600 underline"
              href={DISTRIBUTABLE_LINK}
            >
              Host your own server today!
            </a>
          </h3>
        </div>
